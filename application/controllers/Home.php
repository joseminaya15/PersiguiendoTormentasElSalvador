			                            ...
			                            <tr>
			                                <td style="background-color: #415564;width:100%;">
			                                    <table width="500" cellspacing="0" cellpadding="0" border="0" style="background-color: #415564;padding: 10px 20px;width: 100%;">
			                                        <tr>
														<td><a href="#"><img src="http://iradianty.com/HPE/events/microsite/persiguiendotormentas/ElSalvador/public/img/logo/hpe-logo.png" width="125" alt="alternative text" border="0" style="display: block;"></a></td>
			                                        </tr>
			                                    </table>
			                                </td>
			                            </tr>
			                            <tr>
			                                <td>
			                                    <table width="400" cellspacing="0" cellpadding="0" border="0" align="center" style="padding: 30px 10px">
													...
													<tr>
														<td><img src="http://iradianty.com/HPE/events/microsite/persiguiendotormentas/ElSalvador/public/img/logo/logo-orbe.png" width="100" height="140" style="display: block;margin:auto;margin-bottom: 10px;"></td>
													</tr>
			                                        <tr>
